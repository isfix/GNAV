...
void main() {
  group('GeoMath Tests', () {
    test('Haversine Distance', () {
      final p1 = const LatLng(0, 0);
      final p2 = const LatLng(0, 1); // ~111km
    ...
    test('Distance To Segment (Point On Line)', () {
      ...
      final end = const LatLng(0, 10);
      final p = const LatLng(0, 5); // Middleware
    ...
    test('Distance To Segment (Point Off Line)', () {
      final start = const LatLng(0, 0);
      final end = const LatLng(0, 0.001); // Small segment Vertical
      final p = const LatLng(0.001, 0.0005); // To the side
